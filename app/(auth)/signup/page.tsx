...
export default function Signup() {
  ...
  const validateForm = () => {
    ...
    if (!gdprConsent) {
      setGdprError("You must accept the Privacy Policy and Terms to continue");
      isValid = false;
    } else {
      setGdprError("");
    }
      ...
      if (error instanceof FirebaseError) {
        switch (error.code) {
          ...
          case "auth/weak-password":
            setFirebaseError("Password should be at least 6 characters long.");
            break;
          default:
            console.error("Firebase error during signup:", error.message);
            setFirebaseError(
              "An error occurred during signup. Please try again."
            );
        }
      } else if (error instanceof Error) {
        console.error("Session error during signup:", error.message);
                ...
                <div className="flex items-start">
                  ...
                  <div className="ml-3 text-sm">
                    ...
                    <p className="text-gray-500">
                      ...
                      data for the purpose of using this exam platform.
                    </p>
                    {gdprError && (
                      <p className="mt-1 text-sm text-red-600">{gdprError}</p>
                    )}
                  </div>
                </div>
              </div>
